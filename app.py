...
class Application:
  ...
  #   self.photo1 = tk.PhotoImage(file='Pictures/sachu.png')
  ...
  #   self.tx6.config(text = "SACHU\n2018CO1596", font = ("Courier",15,"bold"))

  #   self.photo2 = tk.PhotoImage(file='Pictures/.png')
  ...
  #   self.photo3 = tk.PhotoImage(file='Pictures/.png')
